  ...
  return (
    ...
    >
      <Button
        type="text"
        size="small"
        disabled={uiInFocus === 'help' || !(uiInFocus === 'applet' ? canUndoApplet : canUndoInput)}
        onClick={() =>
      ...
      <Button
        type="text"
        size="small"
        disabled={uiInFocus === 'help' || !(uiInFocus === 'applet' ? canRedoApplet : canRedoInput)}
        onClick={() =>
          useGlobalUIStore.getState().uiInFocus === 'applet'
