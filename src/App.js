...
export const App = () => {
    ...
    return (React.createElement(Drawer, { open: true, mask: false },
        React.createElement(ParametricInput, { versionEnumSemantics: version0EnumSemantics }),
        localStorage.getItem('iAmJonas') === 'true' ? (React.createElement(Button, { style: { position: 'fixed', top: '15px', right: '15px' }, onClick: downloadPNG },
            React.createElement(SaveOutlined, { style: { position: 'absolute', width: 20, height: 20 }, size: 16 }))) : null));
};
